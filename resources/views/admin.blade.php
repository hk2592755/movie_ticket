        ...
        <section class="wrapper">
          <div class="row">
            ...
            <div class="col-lg-3 ds">
              ...
              <div class="desc">
                <div class="thumb">
                  <img class="img-circle" src="{{asset('assets/admin_panel/img/ui-divya.jpg')}}" width="35px" height="35px" align="">
                </div>
                <div class="details">
                  <p>
              ...
              <div class="desc">
                <div class="thumb">
                  <img class="img-circle" src="{{asset('assets/admin_panel/img/ui-sherman.jpg')}}" width="35px" height="35px" align="">
                </div>
                <div class="details">
                  <p>
              ...
              <div class="desc">
                <div class="thumb">
                  <img class="img-circle" src="{{asset('assets/admin_panel/img/ui-danro.jpg')}}" width="35px" height="35px" align="">
                </div>
                <div class="details">
                  <p>
              ...
              <div class="desc">
                <div class="thumb">
                  <img class="img-circle" src="{{asset('assets/admin_panel/img/ui-zac.jpg')}}" width="35px" height="35px" align="">
                </div>
                <div class="details">
                  <p>
