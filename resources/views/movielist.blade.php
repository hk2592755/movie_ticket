                        ...
                        <div class="tab-item active">
                            <div class="movie-area mb-10">
                                <div class="movie-list">
                                    ...
                                    <div class="movie-thumb c-thumb" >
                                        <a href="/moviedetail/{{$item->id}}" class="w-100 bg_img h-100" data-background="{{asset('uploads/' . $item->file_path)}}">
                                            <img class="d-sm-none" src="{{asset('uploads/' . $item->file_path)}}" alt="movie">
                                        </a>
                                    </div>
                                    <div class="movie-content bg-one">
                                        <h5 class="title">
                                        ...
                                        <div class="movie-tags">
                                            <a href="#0">{{$item->genre}}</a>

                                        </div>
                                        <div class="release">
                                            <span>Release Date : </span> <a href="#0"> {{$item->date}}</a>
                                        </div>
                                        <ul class="movie-rating-percent">
                                            <li>
                                                <div class="thumb">
                                        ...
                                        <div class="book-area">
                                            <div class="book-ticket">
                                                ...
                                                <div class="react-item">
                                                    <a href="{{asset('uploads/trailers/' . $item->trailer_path)}}" class="popup-video">
                                                        <div class="thumb">
